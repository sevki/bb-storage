...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:rXgn5koUFtX/2WLczoHVKxGqhIsLt79CUJsm3VUqOu4=",
        version = "v0.6.2-0.20210915190518-848cd32d1009",
    )
    go_repository(
    ...
    go_repository(
        ...
        patches = ["//:patches/io_opentelemetry_go_otel_exporters_jaeger/http-client.diff"],
