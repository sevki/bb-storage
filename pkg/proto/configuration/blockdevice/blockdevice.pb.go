...
func file_pkg_proto_configuration_blockdevice_blockdevice_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_pkg_proto_configuration_blockdevice_blockdevice_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*FileConfiguration); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_pkg_proto_configuration_blockdevice_blockdevice_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	file_pkg_proto_configuration_blockdevice_blockdevice_proto_msgTypes[1].OneofWrappers = []interface{}{
